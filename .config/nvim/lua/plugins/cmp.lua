return {
    {
    ...
    }, {"Gelio/cmp-natdat", config = true}, {"hrsh7th/cmp-nvim-lsp"}, {
        "L3MON4D3/LuaSnip",
            ...
            ls.add_snippets(nil, {
                all = {
                    s({trig = "box", wordTrig = true}, {
                        ...
                        t {"#"}, f(replace_each "#", {1}), t {"###", "# "}, i(1, {"content"}), t {" #", "###"},
                        f(replace_each "#", {1}), t {"#"}, i(0)
        ...
        "hrsh7th/nvim-cmp",
        dependencies = {
            {"hrsh7th/cmp-buffer"}, {"hrsh7th/cmp-path"}, {"mtoohey31/cmp-fish"}, {"hrsh7th/cmp-nvim-lua"},
            {"andersevenrud/cmp-tmux"}, {"hrsh7th/cmp-emoji"}, {"lukas-reineke/cmp-rg"}, {"onsails/lspkind-nvim"}
        },
        config = function()
            ...
            cmp.setup({
                ...
                sources = cmp.config.sources({
                    {name = "nvim_lsp", max_item_count = 5}, {name = "natdat", max_item_count = 5},
                    {name = "rg", max_item_count = 5}, {name = "cmp_tabnine", max_item_count = 5},
                    {name = "buffer", max_item_count = 5},
                    {name = "tmux", max_item_count = 5, option = {all_panes = true}},
                    {name = "path", max_item_count = 5}, {name = "fish", max_item_count = 5},
