...
function __gitleaks_prepare_completions
    ...
    set -l results (__gitleaks_perform_completion)
    __gitleaks_debug "Completion results: $results"
    ...
    set --global __gitleaks_comp_results $results[1..-2]
...
complete -c gitleaks -n '__gitleaks_prepare_completions' -f -a '$__gitleaks_comp_results'
